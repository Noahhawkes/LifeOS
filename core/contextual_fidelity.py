...
class ContextualFidelityEngine:
    ...
    Does not perform network calls or file IO.
    """
    ...
    def classify_seriousness(cls, message: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        if is_strict:
            if "legal" in msg_lower or "patent" in msg_lower:
                mode = "legal_boundary"
            elif "money" in msg_lower or "billing" in msg_lower:
                mode = "financial_boundary"
            elif "health" in msg_lower or "medical" in msg_lower:
                mode = "health_boundary"
            elif re.search(r"publish", context_tags):
                mode = "public_witness"
            else:
                mode = "serious_factual"
            return {
            ...
            return {
                ...
                "reason": "User message triggers system construction or architectural engineering execution."
            }
    ...
    def build_context_policy(cls, user_message: str, available_context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        must_preserve_raw = rec_mode in ["passive_continuity", "memory_recovery", "public_witness"]
    ...
    def apply_fidelity_rules(cls, draft_response: str, policy: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Test 1: Absolute prohibition of fictionalized certainty claims about recall
